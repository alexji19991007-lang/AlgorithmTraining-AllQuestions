...
public class WordLadder2 {
    public static void main(String[] args) {
        String beginWord = "cbd", endWord = "ccc";
        WordLadder2 wd = new WordLadder2();
        List<List<String>> list = wd.findLadders(beginWord, endWord, Arrays.asList("dbd", "dcb", "ccb",
                "bba", "adc", "dbb", "cbb", "cbd", "ddb", "adb", "aca", "ccc", "dba"));
